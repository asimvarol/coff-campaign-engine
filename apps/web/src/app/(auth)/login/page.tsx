...
import { ArrowRight01Icon, Loading03Icon, Eye01Icon } from '@/lib/icons'
  ...
  return (
    <Card className="border-border/50 bg-card/40 backdrop-blur-2xl shadow-2xl">
      <CardHeader className="space-y-1">
        <CardTitle as="h1" className="text-2xl font-bold">Welcome back</CardTitle>
        <CardDescription>
